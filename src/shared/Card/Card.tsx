    ...
    return (
        <article className={classnames(c.article, mosaic ? c.mosaic: "", "p-[14px] w1024:px-[0]")}>
            ...
            </div>
            {
                stock ?
                    <>
                        <div className={classnames("pl-[36px] pr-[36px] w-[100%] mt-auto w1024:px-[6px]", mosaic ? "w1024:hidden" : "")}>
                ...
                </button>
                {
                    discount ?
                        <>
                            <div className="">
                                <div>
                                    <span className="fs-15 fw-600 text-danger leading-[.5] line-through text-right block">{price}₽</span>
                                </div>
                                <span className="fs-24 fw-600 text-neutral-900">{discount}₽</span>
                            </div>
                        </> : <span className="fs-24 fw-600 text-neutral-900">{price}₽</span>
