    ...
    return (
        <footer className='bg-[#25282B] text-white w1024-min:wrap py-[40px] pb-[60px]'>
                                ...
                                <button>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <rect x="21.5" y="2.5" width="19" height="19" rx="1.5"
                                              transform="rotate(90 21.5 2.5)" fill="#367639" stroke="#CECECE"
            ...
            <div className="pt-[20px] border-t-[1px] border-[var(--color-neutral-0)] mt-[20px] grid grid-cols-3 items-center w-[100%] w1024:hidden">
                ...
                <div className="flex gap-[20px]">
                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="min-w-[50px] min-h-[50px]">
