        ...
        <>
            ...
            >
                <MediaQuery query="(min-width: 1025px)">
                    ...
                    <div className={classnames(c.header__ul, "wrap")}>
                        <ul className='flex justify-between gap-1 lg:gap-8 w1260:gap-[0px] py-1'>
                            ...
                            <li onClick={() => setActive(!active)}
                                className='transition-colors hover:text-[var(--color-primary)] whitespace-nowrap p-1 fs-15 font-medium cursor-pointer'>ВИНО РОССИИ
                            </li>
                            <li onClick={() => setActive(!active)}
                                className='transition-colors hover:text-[var(--color-primary)] whitespace-nowrap p-1 fs-15 font-medium cursor-pointer'>ИГРИСТОЕ ВИНО
                            </li>
                            <li onClick={() => setActive(!active)}
                            ...
                            <li onClick={() => setActive(!active)}
                                className='transition-colors hover:text-[var(--color-primary)] whitespace-nowrap p-1 fs-15 font-medium cursor-pointer'>КРЕПКИЕ НАПИТКИ
                            </li>
                            <li onClick={() => setActive(!active)}
                                className='transition-colors hover:text-[var(--color-primary)] whitespace-nowrap p-1 fs-15 font-medium cursor-pointer'>АКСЕССУАРЫ И
                                ПОДАРКИ
                            </li>
                            <li onClick={() => setActive(!active)}
                ...
                <div className={classnames(
                    (active ? "visible w1024:h-[100vh]" : "hidden"), c.header__list
                )}>
                    <div
                        className={
                            classnames("pt-[36px] border-t-[#C7C7C7] gap-y-[20px] border-t-[1px] wrap grid grid-cols-6 w1024:grid-cols-1 w1024:pb-4 w1024:border-b-[1px] border-[var(--color-neutral-900)]")
                        }>
                        <List></List>
                        <List></List>
                        <List></List>
