                    ...
                    <div className="w-[100%]">
                        ...
                        <div className="border-x-[1px] border-[var(--color-neutral-700)]">
                            ...
                            <MediaQuery query="(max-width:1024px)">
                                <div className="grid grid-cols-4 gap-[10px] bg-[#DBDCDE] items-center px-[20px] py-[10px]">
                                    <span className="fs-15 fw-400 text-black">Номер заказа</span>
                                    <span className="fs-15 fw-400 text-black">Сумма</span>
                                    <span className="fs-15 fw-400 text-black">Статус</span>
                                </div>
    ...
    return (
        <div className="border-b-[1px] border-[var(--color-neutral-700)]">
            <button onClick={() => setActive(!active)}
                    className="h-[50px] grid grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr] w1024:grid-cols-4 w-[100%] bg-[#F5F5F5] text-left px-[20px] items-center">
                <MediaQuery query="(min-width:1025px)">
                ...
                <MediaQuery query="(max-width:1024px)">
                    <span className="fs-15 fw-400 text-black whitespace-nowrap">№546798</span>
                    <span className="ml-[10px] fs-15 fw-400 text-black">109 675 ₽</span>
                    <span className="ml-[10px] fs-15 fw-400 text-black">Оплачен</span>
                </MediaQuery>
                {
                    active ?
                        <>
                            <svg className="ml-auto" width="40" height="40" viewBox="0 0 40 40" fill="none"
